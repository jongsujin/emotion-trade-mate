...
export const MOCK_SUMMARY: ReportSummaryProps = {
  ...
  period: '최근 3개월',
  emotionStats: [
    { emoji: '😊', label: '자신감', count: 18, percentage: 38, avgProfit: 182000 },
    { emoji: '🤔', label: '고민', count: 12, percentage: 25, avgProfit: 85000 },
    { emoji: '😰', label: '불안', count: 10, percentage: 21, avgProfit: -23000 },
    { emoji: '😎', label: '여유', count: 8, percentage: 16, avgProfit: 157000 },
  ],
