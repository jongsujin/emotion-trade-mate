  ...
  if (isLoading) {
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-[#8B95A1]">리포트 분석 중...</div>
      </div>
    )
  }

  const { bestEmotion, worstEmotion, details } = reportData?.data || {
    bestEmotion: null,
    worstEmotion: null,
    details: [],
  }
    ...
    return (
      <div className="min-h-screen bg-[#F4F5F7]">
        ...
        <div className="flex flex-col items-center justify-center px-5 pt-20 text-center">
          ...
          <p className="mb-2 text-lg font-bold text-[#191F28]">아직 데이터가 부족해요</p>
